...
export declare const OPEN_MODAL = "CORE/OPEN_MODAL";
...
export declare const CLOSE_MODAL = "CORE/CLOSE_MODAL";
export interface CloseModal {
    type: "CORE/CLOSE_MODAL";
}
export declare const ADD_HOST = "CORE/ADD_HOST";
...
export declare const REMOVE_HOST = "CORE/REMOVE_HOST";
...
export declare const SET_APP_HOST = "SET_APP_HOST";
export interface SetAppHostAction {
    type: "SET_APP_HOST";
    payload: HostRecord;
}
export declare const CHANGE_FILENAME = "CHANGE_FILENAME";
...
export declare const APPEND_OUTPUT = "APPEND_OUTPUT";
...
export declare const UPDATE_DISPLAY = "UPDATE_DISPLAY";
...
export declare const UPDATE_DISPLAY_FAILED = "UPDATE_DISPLAY_FAILED";
...
export declare const ACCEPT_PAYLOAD_MESSAGE = "ACCEPT_PAYLOAD_MESSAGE";
...
export declare const SET_LANGUAGE_INFO = "SET_LANGUAGE_INFO";
...
export declare const OVERWRITE_METADATA_FIELD = "OVERWRITE_METADATA_FIELD";
...
export declare const DELETE_METADATA_FIELD = "DELETE_METADATA_FIELD";
...
export declare const SET_CONFIG_AT_KEY = "SET_CONFIG_AT_KEY";
...
export declare const MERGE_CONFIG = "MERGE_CONFIG";
...
export declare const LOAD_CONFIG = "LOAD_CONFIG";
export interface LoadConfigAction {
    type: "LOAD_CONFIG";
}
export declare const SAVE_CONFIG = "SAVE_CONFIG";
export interface SaveConfigAction {
    type: "SAVE_CONFIG";
}
export declare const DONE_SAVING_CONFIG = "DONE_SAVING_CONFIG";
export interface DoneSavingConfigAction {
    type: "DONE_SAVING_CONFIG";
}
export declare const TOGGLE_OUTPUT_EXPANSION = "TOGGLE_OUTPUT_EXPANSION";
...
export declare const SET_EXECUTION_STATE = "SET_EXECUTION_STATE";
...
export declare const SET_NOTIFICATION_SYSTEM = "SET_NOTIFICATION_SYSTEM";
...
export declare const SET_GITHUB_TOKEN = "SET_GITHUB_TOKEN";
...
export declare const PUBLISH_GIST = "CORE/PUBLISH_GIST";
...
export declare const ADD_TRANSFORM = "ADD_TRANSFORM";
...
export declare const REMOVE_TRANSFORM = "REMOVE_TRANSFORM";
...
export declare const ERROR = "CORE/ERROR";
export declare type CoreError = ErrorAction<"CORE/ERROR">;
