...
export declare const PUBLISH_TO_BOOKSTORE = "CORE/PUBLISH_TO_BOOKSTORE";
...
export declare const PUBLISH_TO_BOOKSTORE_AFTER_SAVE = "CORE/PUBLISH_TO_BOOKSTORE_AFTER_SAVE";
...
export declare const PUBLISH_TO_BOOKSTORE_SUCCEEDED = "CORE/PUBLISH_TO_BOOKSTORE_SUCCEEDED";
...
export declare const PUBLISH_TO_BOOKSTORE_FAILED = "CORE/PUBLISH_TO_BOOKSTORE_FAILED";
